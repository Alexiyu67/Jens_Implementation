...
public class GamePanel extends JFrame {
  ...
  private final Map<String, Image> units = new HashMap<String, Image>();
  ...
  private void loadUnitTiles(MediaTracker tracker) {
    units.put("default_frog", load(5, tracker, "frog.jpg"));
    units.put("bug_green", load(6, tracker, "bug1.jpg"));
    units.put("bug_red", load(7, tracker, "bug_s.png"));
    units.put("default_crow", load(8, tracker, "crow_s.png"));
    units.put("default_scarecrow", load(9, tracker, "scarecrow.jpg"));
    units.put("default_plant", load(10, tracker, "plant.jpg"));
    units.put("default_jens", load(11, tracker, "jens_final.png"));
  }
